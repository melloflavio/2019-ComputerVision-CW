...
\usepackage{url}
% \usepackage[hidelinks]{hyperref} % hyperlinks within text body
% \hypersetup{
%     colorlinks=true,
%     linkcolor=black,
%     urlcolor=blue,
...
\subsection{Strategy}
    ...
    \subsubsection{Results}
        After much tuning with the parameters mentioned above, the final version of the pipeline, when tested against a balanced sample of the individual data (pictures and videos) with 280 files, correctly identified the labels in 85\% of the media while only 13\% of its predicted labels were incorrect ones.
