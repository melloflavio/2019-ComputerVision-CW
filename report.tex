...
\subsection{Strategy}
    ...
    \subsubsection{Results}
        After much tuning with the parameters mentioned above, the final version of the pipeline, when tested against all the individual data (pictures and videos) correctly identified the labels in 90\% of the media while only ???\% of its predicted labels were incorrect ones.
